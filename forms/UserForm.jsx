...
function UserTable() {
  ...
  return (
    <div className='flex w-full gap-4'>
      {isLoading && <div className='w-full p-6 text-left border rounded'>Loading...</div>}
      {!isLoading && !data.length && (
        <div className='w-full p-6 text-left border rounded'>No data found</div>
      )}
      {!isLoading && data.length && (
        <DataTable
          columns={[
      ...
      <div className='w-2/5 p-6 text-left border rounded'>
